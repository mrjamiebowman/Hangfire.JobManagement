...
var cronstrueWithLocales = __webpack_require__(785);
...
var rangeValidator_1 = __nested_webpack_require_540__(515);
...
/***/ 333:
/***/ ((__unused_webpack_module, exports, __nested_webpack_require_10927__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ExpressionDescriptor = void 0;
var stringUtilities_1 = __nested_webpack_require_10927__(823);
var cronParser_1 = __nested_webpack_require_10927__(949);
...
/***/ 99:
/***/ ((__unused_webpack_module, exports, __nested_webpack_require_36783__) => {
...
/***/ 420:
/***/ ((__unused_webpack_module, exports, __nested_webpack_require_42857__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.allLocalesLoader = void 0;
var allLocales = __nested_webpack_require_42857__(99);
...
/******/ 	function __nested_webpack_require_263819__(moduleId) {
...
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_263819__);
/******/ 	
...
var expressionDescriptor_1 = __nested_webpack_require_263819__(333);
var allLocalesLoader_1 = __nested_webpack_require_263819__(420);
...
__webpack_require__.d(__webpack_exports__, {
  CronExpressionInput: () => (/* reexport */ CronExpressionInput),
  CronFields: () => (/* reexport */ CronFields),
...
var CronComponent = /*#__PURE__*/function (_HTMLElement) {
  function CronComponent() {
    ...
    return _callSuper(this, CronComponent);
  }
  _inherits(CronComponent, _HTMLElement);
  return _createClass(CronComponent, [{
    key: "Init",
...
function CronFields_typeof(o) { "@babel/helpers - typeof"; return CronFields_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, CronFields_typeof(o); }
function CronFields_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function CronFields_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, CronFields_toPropertyKey(o.key), o); } }
function CronFields_createClass(e, r, t) { return r && CronFields_defineProperties(e.prototype, r), t && CronFields_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function CronFields_toPropertyKey(t) { var i = CronFields_toPrimitive(t, "string"); return "symbol" == CronFields_typeof(i) ? i : i + ""; }
function CronFields_toPrimitive(t, r) { if ("object" != CronFields_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != CronFields_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function CronFields_callSuper(t, o, e) { return o = CronFields_getPrototypeOf(o), CronFields_possibleConstructorReturn(t, CronFields_isNativeReflectConstruct() ? Reflect.construct(o, e || [], CronFields_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function CronFields_possibleConstructorReturn(t, e) { if (e && ("object" == CronFields_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return CronFields_assertThisInitialized(t); }
function CronFields_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function CronFields_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (CronFields_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function CronFields_getPrototypeOf(t) { return CronFields_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, CronFields_getPrototypeOf(t); }
function CronFields_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && CronFields_setPrototypeOf(t, e); }
function CronFields_setPrototypeOf(t, e) { return CronFields_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, CronFields_setPrototypeOf(t, e); }
...
var CronFields = /*#__PURE__*/function (_CronComponent) {
  function CronFields() {
    ...
    return CronFields_callSuper(this, CronFields);
  }
  CronFields_inherits(CronFields, _CronComponent);
  return CronFields_createClass(CronFields, [{
    ...
    value: function makeCron(choice, input) {
      ...
      if (choice == 1) {
        if (input.start == '*') {
          expression = "".concat(input.every);
        } else {
          expression = "".concat(input.start, "/").concat(input.every);
        }
      } else if (choice == 2 && !(input.rangeMin == '*' || input.rangeMax == '*')) {
        var min = parseInt(input.rangeMin);
        var max = parseInt(input.rangeMax);
        if (min < max) {
          expression = "".concat(input.rangeMin, "-").concat(input.rangeMax);
        }
...
function CssTemplateGenerator(obj) {
  return "\ncron-input-ui[id=".concat(obj.id, "] .btn-custom {\n    background-color: ").concat(obj.colorMain, ";\n    border-color: ").concat(obj.colorSecond, ";\n}\n\ncron-input-ui[id=").concat(obj.id, "] .btn-custom:hover {\n    background-color: ").concat(obj.colorSecond, ";\n    border-color: ").concat(obj.colorMain, ";\n}\n\ncron-input-ui[id=").concat(obj.id, "] input[type=\"radio\"]:checked:after {\n    background-color: ").concat(obj.colorMain, ";\n}\n\ncron-input-ui[id=").concat(obj.id, "] .panel:has(input[type=\"radio\"]:checked) {\n    border-color: ").concat(obj.colorMain, ";\n}\n\ncron-input-ui[id=").concat(obj.id, "] input[type=\"radio\"] {\n    border: 1px solid ").concat(obj.colorSecond, ";\n}\n\ncron-input-ui[id=").concat(obj.id, "] .container input:checked ~ .checkmark {\n    background-color: ").concat(obj.colorMain, ";\n}\n\ncron-input-ui[id=").concat(obj.id, "] .container:hover input ~ .checkmark {\n    background-color: ").concat(obj.colorSecond, ";\n}\n    ");
}
;// ./src/templates/CronExpressionInputTemplate.js
function CronExpressionInputTemplateGenerator(obj, objLang) {
  return "\n<div class=\"cronInput element\" style=\"width: ".concat(obj.width, "; height: ").concat(obj.height, ";\">\n    <input class=\"cronInsideInput input\" type=\"text\" class=\"form-control\" placeholder=\"").concat(objLang.inputPlaceholder, "\" name=\"").concat(obj.name, "\" title=\"").concat(obj.title, "\" ").concat(obj.noInput ? 'readonly' : '', " />\n    <button type=\"button\" class=\"cronButton btn btn-custom\">\n        <svg width=\"1rem\" height=\"1rem\" viewBox=\"0 0 16 16\" class=\"bi bi-pencil-square\" fill=\"white\">\n            <path d=\"M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z\" />\n            <path fill-rule=\"evenodd\" d=\"M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z\" />\n        </svg>\n    </button>\n</div>\n<i><small class=\"cronExpressionMessage\"></small></i>\n<small class=\"cronExpressionMissing hidden\">").concat(objLang.missingCron, "</small>\n<small class=\"cronExpressionError error hidden\">").concat(objLang.invalidCron, "</small>\n<div class=\"modal\" tabindex=\"-1\">\n    <div class=\"modal-dialog\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <span class=\"cronClose top-action\">\n                    <svg width=\"1.4rem\" height=\"1.4rem\" viewBox=\"0 0 16 16\" class=\"bi bi-x-circle\" fill=\"").concat(obj.colorMain, "\">\n                        <path fill-rule=\"evenodd\" d=\"M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z\" />\n                        <path fill-rule=\"evenodd\" d=\"M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z\" />\n                    </svg>\n                </span>\n                <span class=\"cronSave top-action\">\n                    <svg width=\"1.4rem\" height=\"1.4rem\" viewBox=\"0 0 16 16\" class=\"bi bi-check-circle\" fill=\"").concat(obj.colorMain, "\">\n                        <path fill-rule=\"evenodd\" d=\"M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z\" />\n                        <path fill-rule=\"evenodd\" d=\"M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z\" />\n                    </svg>\n                </span>\n            </div>\n            <div class=\"modal-body\">\n                <ul class=\"nav nav-tabs\">\n                    <li class=\"nav-item ").concat(obj.defaultTab === 'minutes' ? 'active' : '', "\">\n                        <a class=\"nav-link\">").concat(objLang.minutes, "</a>\n                    </li>\n                    <li class=\"nav-item ").concat(obj.defaultTab === 'hours' ? 'active' : '', "\">\n                        <a class=\"nav-link\">").concat(objLang.hours, "</a>\n                    </li>\n                    <li class=\"nav-item ").concat(obj.defaultTab === 'days-of-month' ? 'active' : '', "\">\n                        <a class=\"nav-link\">").concat(objLang.daysOfMonth, "</a>\n                    </li>\n                    <li class=\"nav-item ").concat(obj.defaultTab === 'months' ? 'active' : '', "\">\n                        <a class=\"nav-link\">").concat(objLang.month, "</a>\n                    </li>\n                    <li class=\"nav-item ").concat(obj.defaultTab === 'days-of-week' ? 'active' : '', "\">\n                        <a class=\"nav-link\">").concat(objLang.daysOfWeek, "</a>\n                    </li>\n                </ul>\n                <input class=\"inputCronMsg form-control\" disabled />\n                <div class=\"tab-content\">\n                    <div class=\"tab-pane ").concat(obj.defaultTab === 'minutes' ? 'active' : 'fade', "\">\n                        <cron-fields pos=\"0\" input=\"minutes\" hasZero=\"true\" every=\"59\" colorMain=\"").concat(obj.colorMain, "\" colorSecond=\"").concat(obj.colorSecond, "\" />\n                    </div>\n                    <div class=\"tab-pane ").concat(obj.defaultTab === 'hours' ? 'active' : 'fade', "\">\n                        <cron-fields pos=\"1\" input=\"hours\" hasZero=\"true\" every=\"23\" colorMain=\"").concat(obj.colorMain, "\" colorSecond=\"").concat(obj.colorSecond, "\" />\n                    </div>\n                    <div class=\"tab-pane ").concat(obj.defaultTab === 'days-of-month' ? 'active' : 'fade', "\">\n                        <cron-fields pos=\"2\" input=\"daysOfMonth\" every=\"31\" colorMain=\"").concat(obj.colorMain, "\" colorSecond=\"").concat(obj.colorSecond, "\" />\n                    </div>\n                    <div class=\"tab-pane ").concat(obj.defaultTab === 'months' ? 'active' : 'fade', "\">\n                        <cron-fields pos=\"3\" input=\"months\" every=\"12\" colorMain=\"").concat(obj.colorMain, "\" colorSecond=\"").concat(obj.colorSecond, "\" />\n                    </div>\n                    <div class=\"tab-pane ").concat(obj.defaultTab === 'days-of-week' ? 'active' : 'fade', "\">\n                        <cron-fields pos=\"4\" input=\"daysOfWeek\" hasZero=\"true\" every=\"7\" colorMain=\"").concat(obj.colorMain, "\" colorSecond=\"").concat(obj.colorSecond, "\" />\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n    ");
}
// EXTERNAL MODULE: ./node_modules/cronstrue/i18n.js
var i18n = __webpack_require__(222);
// EXTERNAL MODULE: ./node_modules/cron-validator/lib/index.js
var lib = __webpack_require__(632);
;// ./src/utils.js


function humanize(value, inputLangInternal) {
  var cronstrueLang = 'en';
  if (Object.keys(i18n["default"].locales).includes(inputLangInternal.code)) {
    cronstrueLang = inputLangInternal.code;
  }
  return i18n.toString(value, {
    locale: cronstrueLang
  });
}

;// ./src/nodes/CronExpressionInput.js
function CronExpressionInput_typeof(o) { "@babel/helpers - typeof"; return CronExpressionInput_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, CronExpressionInput_typeof(o); }
function CronExpressionInput_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function CronExpressionInput_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, CronExpressionInput_toPropertyKey(o.key), o); } }
function CronExpressionInput_createClass(e, r, t) { return r && CronExpressionInput_defineProperties(e.prototype, r), t && CronExpressionInput_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function CronExpressionInput_toPropertyKey(t) { var i = CronExpressionInput_toPrimitive(t, "string"); return "symbol" == CronExpressionInput_typeof(i) ? i : i + ""; }
function CronExpressionInput_toPrimitive(t, r) { if ("object" != CronExpressionInput_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != CronExpressionInput_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function CronExpressionInput_callSuper(t, o, e) { return o = CronExpressionInput_getPrototypeOf(o), CronExpressionInput_possibleConstructorReturn(t, CronExpressionInput_isNativeReflectConstruct() ? Reflect.construct(o, e || [], CronExpressionInput_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function CronExpressionInput_possibleConstructorReturn(t, e) { if (e && ("object" == CronExpressionInput_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return CronExpressionInput_assertThisInitialized(t); }
function CronExpressionInput_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function CronExpressionInput_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (CronExpressionInput_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function CronExpressionInput_getPrototypeOf(t) { return CronExpressionInput_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, CronExpressionInput_getPrototypeOf(t); }
function CronExpressionInput_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && CronExpressionInput_setPrototypeOf(t, e); }
function CronExpressionInput_setPrototypeOf(t, e) { return CronExpressionInput_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, CronExpressionInput_setPrototypeOf(t, e); }
...
if (typeof inputLang == 'undefined') {
  CronExpressionInput_inputLangInternal = en;
} else {
  CronExpressionInput_inputLangInternal = inputLang["default"];
}
var CronExpressionInput = /*#__PURE__*/function (_CronComponent) {
  function CronExpressionInput() {
    ...
    return CronExpressionInput_callSuper(this, CronExpressionInput);
  }
  CronExpressionInput_inherits(CronExpressionInput, _CronComponent);
  return CronExpressionInput_createClass(CronExpressionInput, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      ...
      this.addEvent('.cronButton', 'click', function () {
      ...
      if (self.hotValidate) {
        this.addEvent('.cronInsideInput', 'input', function () {
      ...
      if (this.hideOtherTabs) {
        this.getElements('.form-check-input').forEach(function (element) {
          element.onchange = function () {
            ...
            formPanel.forEach(function (panel) {
    ...
    value: function validator(self) {
      ...
      if (insideInput.value.length != 0 && !(0,lib.isValidCron)(insideInput.value, {
    ...
    value: function setValue(value) {
      ...
      if (value == undefined) {
        ...
        for (var i = 0; i < 5; i++) if (array[i] != undefined) {
          defaultArray[i] = array[i];
        }
        value = defaultArray.join(' ');
      }
      this.getElement('.cronInsideInput').value = value;
      var humanString = humanize(value, CronExpressionInput_inputLangInternal);
